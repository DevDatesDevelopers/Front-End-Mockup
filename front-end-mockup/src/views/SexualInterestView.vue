<template>
    <div class="flex flex-col items-center">
      ...
      <h2 class="text-left font-semibold w-10/12 py-4">I am interested in:</h2>
...
import  router from '../router';
  ...
  let options = ref([
      { name: "Men", active: false, id: "man-select" },
      { name: "Women", active: false, id: "woman-select" },
  ...
  function routing(){
    ...
    store.seaxualInterest = selected;
    console.log(store.seaxualInterest);
