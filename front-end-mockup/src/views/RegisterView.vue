...
<template>
    <div class="flex flex-col items-center">
        ...
        <form class="flex flex-col w-10/12 items-center" lazy-validation>
            <input @change="displayProfilePic(this)" id="profPicInput" type="file" ref="profilePic" name="picture" accept="image/gif, image/jpeg, image/png" class="hidden"/>
            ...
            <div id="profileImageContainter" class="w-24 aspect-square bg-content rounded-xl mb-8">
                <lable for="picture" class="w-fit cursor-pointer absolute mt-16 ml-16" @click="addImage()">
                    <span class="block w-fit bg-primary-purple text-white p-2 rounded-full border-[3px]"><Icon icon="jam:camera-f" style="width: 25px; height: 25px;" class=""/></span>
                </lable>
            </div>
            ...
            <button type="submit" class="btn-continue w-full">Continue</button>
        </form>
